...
$(document).ready(function() {
    ...
    $(".term-colapse").click(function() {
        $(".colapse-content").toggleClass("show");
    });
...
var fullnameValidation = function() {
    ...
    validfullname = /^[A-Za-z][A-Za-z\'\-]+([\ A-Za-z][A-Za-z\'\-]+)*/;
...
var phoneValidation = function() {
    ...
    validphone = /^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/;
...
var countryValidation = function() {
    ...
    countryErr = document.getElementById('country-err');
